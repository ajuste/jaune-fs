 ...
 */
"use strict";
var FSClientStat, FSFileSystem, convertPathToAbsolute, createReadStream, createWriteStream, join, mime, ncp, readFile, ref, rename, stat, stream, unlink, writeFile;
...
ref = require("fs"), createReadStream = ref.createReadStream, createWriteStream = ref.createWriteStream, rename = ref.rename, readFile = ref.readFile, stat = ref.stat, writeFile = ref.writeFile, unlink = ref.unlink;
