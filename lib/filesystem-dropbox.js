...
const _q               = require("q");
const _writeReadStream = require("jaune-util").WriteReadStream;

/**
 * @class Dropbox file system client constructor.
 * @param {Object} connection Accepts the connection to the file system.
 */
const DropboxClient = function(connection) {
  this.dbClient = new _dropbox.Client(connection);
};
/**
* Prototype
*/
DropboxClient.prototype = {
  ...
  readFile : function* (path) {
    ...
    const stream = new _writeReadStream();
